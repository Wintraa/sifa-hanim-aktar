  ...
  return (
    <header className="topbar">
      <div className="topbar__left">
        ...
        <Link to="/" className="topbar__brand" aria-label="Ana sayfa — Şifa Hanım Aktar">
          <img
            className="site-logo topbar__logo"
            src={SITE_LOGO_SRC}
            alt={SITE_LOGO_ALT}
            width="160"
            height="64"
        ...
        <div className="topbar__titles">
          ...
          <p className="topbar__subtitle">Şifalı bitki kütüphanesi</p>
        </div>      </div>

      <div className="topbar__right">
        <label className="search-box" htmlFor="searchInput">
          <span className="visually-hidden">
            Bitki ara. Kısayol: / odaklanır, Esc kapatır.
          </span>
          <span className="search-box__field">
            <input
              ...
              type="search"
              name="q"
              placeholder="Şifa Hanım Aktar arşivinde bitki veya botanik adı ara... [/]"
              autoComplete="off"
              enterKeyHint="search"
              value={searchValue}
